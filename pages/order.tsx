  ...
  return (
    <Container noNavbar noTopMargin>
      {loading ? (
        ...
        <>
          <header className="print:hidden z-50 sticky mb-5 top-0 py-4 bg-white/10 dark:bg-gray-900/10 backdrop-blur shadow-sm">
            <Wrapper>
            ...
            <div className="flex flex-col-reverse lg:flex-row">
              ...
              <div className="flex-[1] max-w-3xl mx-auto print:max-w-none print:mx-0">
                ...
                <div className="mt-5 flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 print:flex-row print:space-y-0 print:space-x-4">
                  <div className="w-full font-medium text-sm p-2 border border-l-2 border-l-green-500 md:border-l md:border-l-gray-200 md:border-t-4 md:border-t-green-500 print:border-l print:border-l-gray-200 print:border-t-4 print:border-t-green-500 rounded-xl dark:border-gray-700 dark:bg-gray-800 dark:border-l-green-500 md:dark:border-l-gray-700 md:dark:border-t-green-500">
                ...
                <div className="mt-10 print:hidden">
                  ...
                  {finishedOrder.rating && (
                    <div className="mt-3 p-2 rounded-xl border border-green-300 bg-green-100 dark:bg-green-600 dark:border-green-400">
                      Thank you
                      {finishedOrder.user && (
                        <>
                  ...
                  >
                    <div>
                      <ReactStars
                        count={5}
                        emptyIcon={
                          <StarIcon className="w-10 h-10 dark:text-gray-600" />
                        }
                        filledIcon={
                    ...
                    <textarea
                      ...
                      className={cn(
                        'mt-3 px-3 py-2 border border-gray-300 dark:bg-gray-800 dark:border-gray-700  focus:outline-none focus:border-green-400',
                        finishedOrder.rating ? 'rounded-md' : 'rounded-t-md'
                      )}
                ...
                <div className="mt-10 flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
                  ...
                  {/* CONTACT */}
                  <div className="print:hidden flex-[1] p-4 border dark:border-gray-700 rounded-2xl text-gray-500">
                    <p>
                      <span className="font-semibold">Punya pertanyaan ?</span>{' '}
                ...
                <button
                  ...
                  className="print:hidden mt-8 w-full flex items-center justify-center py-3 rounded-2xl border border-gray-900 font-semibold hover:bg-gray-900 hover:text-white transition-colors dark:bg-gray-800/80 dark:hover:bg-gray-800/40"
                >
